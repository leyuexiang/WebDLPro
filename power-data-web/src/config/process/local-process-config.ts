...
const pageSeeds: readonly PageSeed[] = [
  ...
  { pageId: 'gas-turbine', domainId: 'gas-power', processId: 'gas-power-generation', title: '燃气轮机', description: '燃气轮机子流程。', order: 3 },
...
const gasGuide: ProcessGuideDefinition = {
  ...
  steps: [
    ...
    { stepId: toProcessStepId('gas-turbine'), title: '燃气轮机', description: '聚焦燃机并联动两条已确认的排气至余热锅炉烟道。', nodeIds: [toProcessNodeId('gas-turbine'), toProcessNodeId('hrsg')], activeRouteIds: [toRouteId('route.exhaust-to-hrsg.1'), toRouteId('route.exhaust-to-hrsg.2')], order: 4 },
    { stepId: toProcessStepId('hrsg'), title: '余热锅炉', description: '余热锅炉当前为合并模型，炉体、汽包和烟囱只能以热点细分。', nodeIds: [toProcessNodeId('hrsg'), toProcessNodeId('gas-turbine')], activeRouteIds: [toRouteId('route.exhaust-to-hrsg.1'), toRouteId('route.exhaust-to-hrsg.2')], order: 5 },
    { stepId: toProcessStepId('steam-turbine'), title: '汽轮机', description: '汽轮机至冷凝器的方向与介质待确认，暂不下发三维路由。', nodeIds: [toProcessNodeId('steam-turbine')], activeRouteIds: [], order: 6 },
